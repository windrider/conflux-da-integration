...
echo "Funding DA accounts from Conflux default genesis account..."

# Conflux default genesis private key (in EVM space)
GENESIS_PRIVATE_KEY="0x46b9e861b63d3509c88b7817275a30d22d62c8cd8fa6486ddee35ef0d8e0495f"

# Accounts to fund
DA_NODE_SIGNER="0x9685c4eb29309820cdc62663cc6cc82f3d42e964"
DA_CONTRACT_DEPLOYER="0xa223d305bc8147a75761f7f72f983e5eef867bd4"

# RPC URL
RPC_URL="http://127.0.0.1:8545"

echo "Using Python to send transactions..."

# Create a temporary Python script
cat > /tmp/fund_accounts.py << 'EOF'
...
# Run the script
python3 /tmp/fund_accounts.py

# Clean up
rm /tmp/fund_accounts.py
